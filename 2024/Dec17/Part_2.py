...
for iter in range(5 * 35184372088832 + 5000000000000, 6 * 35184372088832):
    register["A"] = iter
    result = computer(register, program)
    print(iter, ": ", result)
    str_result = ",".join([str(num) for num in result])
    #print(str_result)
    #if iter/10000 == float(iter//10000):
    #    print(iter, ": ", result)
    if str_result == "2,4,1,1,7,5,4,7,1,4,0,3,5,5,3,0":
        print("Found it!", iter)
        break
